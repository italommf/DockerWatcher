...
from api.views import jobs, rpas, cronjobs, deployments, pods, executions, connection, config, falhas, resources, dashboard, stream
...
urlpatterns = [
    ...
    # SSE Streaming endpoints (tempo real)
    path('stream/dashboard/', stream.stream_dashboard, name='stream-dashboard'),
    path('stream/jobs/', stream.stream_jobs, name='stream-jobs'),
]
